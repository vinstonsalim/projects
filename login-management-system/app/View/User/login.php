<div class="container col-xl-10 col-xxl-8 px-4 py-5">
    ...
    <div class="row align-items-center g-lg-5 py-5">
        <div class="col-lg-7 text-center text-lg-start">
            ...
            <p class="col-lg-10 fs-4"><a target="_blank" href="https://de.linkedin.com/in/vinstonsalim">Vinston Salim</a></p>
        </div>
        <div class="col-md-10 mx-auto col-lg-5">
            <form class="p-4 p-md-5 border rounded-3 bg-light" method="post" action="/users/login">
                <div class="form-floating mb-3">
                    <input name="id" type="text" class="form-control" id="id" placeholder="<?= $_POST['id'] ?? "" ?>">
